...
//   export default function MainBlock({ lessonListen }:MainComponentProps) {
//     return(
//         <div className="w-1/2 flex flex-row justify-center flex-wrap items-center pt-10 pb-10">
//         {lessonListen.map((item, index) => (
...
//               <p className="w-fit bg-white z-10 p-5 relative text-3xl rounded-2xl font-semibold">Listen to the audio</p>
//             </div>
...
//                   <Link href={`/play/${list.id}/listen-and-read`} className="w-full">
