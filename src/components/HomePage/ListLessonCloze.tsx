...
type Lesson = {
  ...
  export default function MainBlock({ lessonCloze }:MainComponentProps) {
    return(
        ...
        {lessonCloze.map((item, index) => (
          <div key={index} className="w-full flex flex-col items-center">
            <div className="relative mt-3 w-full flex items-center justify-center">
              ...
              <p className="w-fit bg-white z-10 p-5 relative text-3xl rounded-2xl font-semibold">Check & Correct</p>
            </div>
